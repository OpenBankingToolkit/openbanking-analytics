...
const selector = 'app-security-authorise-requests-chart';
...
export class SecurityAuthoriseRequestsContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
