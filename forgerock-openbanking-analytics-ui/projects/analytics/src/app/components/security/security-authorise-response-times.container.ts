...
const selector = 'app-security-authorise-response-times-chart';
...
export class SecurityAuthoriseResponseTimesContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
