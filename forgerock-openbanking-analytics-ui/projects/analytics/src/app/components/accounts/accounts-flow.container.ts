...
const selector = 'app-accounts-flow-chart';
...
export class AccountsFlowContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    const activityTypeEndpointParams: IActivityTypeEndpointParams = {
      ...
      consentType: 'ACCOUNT_ACCESS_CONSENT'
    };
