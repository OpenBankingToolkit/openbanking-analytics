...
const selector = 'app-payments-domestic-consent-activities-chart';
...
export class PaymentsDomesticConsentActivitiesContainerComponent extends AbstractWidgetChartComponent
  implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    const activityTypeEndpointParams: IActivityTypeEndpointParams = {
      ...
      consentType: 'PAYMENT_DOMESTIC_CONSENT'
    };
