...
const selector = 'app-payments-domestic-scheduled-consent-activities-chart';
...
export class PaymentsDomesticScheduledConsentActivitiesContainerComponent extends AbstractWidgetChartComponent
  implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    const activityTypeEndpointParams: IActivityTypeEndpointParams = {
      ...
      consentType: 'PAYMENT_DOMESTIC_SCHEDULED_CONSENT'
    };
