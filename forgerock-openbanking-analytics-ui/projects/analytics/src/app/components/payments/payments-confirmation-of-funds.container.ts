...
const selector = 'app-payments-cof-activities-chart';
...
export class PaymentsConfirmationOfFundsConsentActivitiesContainerComponent extends AbstractWidgetChartComponent
  implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    return this.metricsService.getPaymentCOF(params);
  }
