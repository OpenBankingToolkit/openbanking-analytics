...
const selector = 'app-payments-international-consent-activities-chart';
...
export class PaymentsInternationalConsentActivitiesContainerComponent extends AbstractWidgetChartComponent
  implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    const activityTypeEndpointParams: IActivityTypeEndpointParams = {
      ...
      consentType: 'PAYMENT_INTERNATIONAL_CONSENT'
    };
