...
const selector = 'app-directory-organisation-chart';
...
export class DirectoryOrganisationContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
