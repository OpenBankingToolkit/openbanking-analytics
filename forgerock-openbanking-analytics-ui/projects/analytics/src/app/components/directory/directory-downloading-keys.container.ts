...
const selector = 'app-directory-downloading-key-chart';
...
export class DirectoryDownloadingKeyContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
