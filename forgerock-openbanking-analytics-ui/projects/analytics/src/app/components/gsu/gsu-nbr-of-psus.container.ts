...
const selector = 'app-gsu-nbr-of-psus-chart';
...
export class GSUNbrOfPSUsContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    return this.metricsService.getNbrOfPSUs(params);
  }
