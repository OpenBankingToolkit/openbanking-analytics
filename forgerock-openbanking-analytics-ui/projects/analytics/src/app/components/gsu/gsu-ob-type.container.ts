...
const selector = 'app-gsu-ob-api-type-chart';
...
export class GSUOBApiTypeContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  responseTransform(response: ILineChartResponse) {
    return convertLineChartReponseToDoughnut(response, 'BY_OB_TYPE');
  }
}
