...
const selector = 'app-events-notifications-flow-chart';
...
export class EventsNotificationsFlowContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    return this.metricsService.createdCallbacks(params);
  }
