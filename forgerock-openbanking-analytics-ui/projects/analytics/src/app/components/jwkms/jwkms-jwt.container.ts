...
const selector = 'app-jwkms-jwt-chart';
...
export class JWKMSJWTContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    return this.metricsService.getJwtsGenerationKPI(params);
  }
