...
import { IChartsEndpointParams, IDoughnutResponse, IState } from 'analytics/src/models';
...
const selector = 'app-jwkms-validation-chart';
...
export class JWKMSValidationContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    return this.metricsService.getJwtsValidationKPI(params);
  }
