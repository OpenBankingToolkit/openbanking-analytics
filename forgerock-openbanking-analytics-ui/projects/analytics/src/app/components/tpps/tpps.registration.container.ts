...
const selector = 'app-tpps-registration-chart';
...
export class TppsRegistrationContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService({ fromDate: from, toDate: to }: IChartsEndpointParams) {
    return this.metricsService.readStats({
      ...
      endpoint: '/open-banking/register/',
      from,
      to
    });
  }
