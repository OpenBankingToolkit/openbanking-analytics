...
const selector = 'app-payments-international-scheduled-consent-activities-chart';
...
export class PaymentsInternationalScheduledConsentActivitiesContainerComponent extends AbstractWidgetChartComponent
  implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    const activityTypeEndpointParams: IActivityTypeEndpointParams = {
      ...
      consentType: 'PAYMENT_INTERNATIONAL_SCHEDULED_CONSENT'
    };
