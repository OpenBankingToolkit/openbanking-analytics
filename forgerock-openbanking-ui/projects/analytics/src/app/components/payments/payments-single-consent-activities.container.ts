...
const selector = 'app-payments-single-consent-activities-chart';
...
export class PaymentsSingleConsentActivitiesContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    const activityTypeEndpointParams: IActivityTypeEndpointParams = {
      ...
      consentType: 'PAYMENT_SINGLE_REQUEST'
    };
