...
const selector = 'app-payments-consents-type-chart';
...
export class PaymentsConsentTypeContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
