...
const selector = 'app-gsu-nbr-obri-sessions-chart';
...
export class GSUNbrOBRISessionsContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    return this.metricsService.getNbrOfOBRISessions(params);
  }
