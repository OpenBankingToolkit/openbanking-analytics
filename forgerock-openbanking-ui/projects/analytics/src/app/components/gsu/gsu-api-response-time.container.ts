...
const selector = 'app-gsu-api-response-times-calls-chart';
...
export class GSUAPIResponseTimesContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
