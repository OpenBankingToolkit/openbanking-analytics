...
const selector = 'app-directory-software-statement-chart';
...
export class DirectorySoftwareStatementContainerComponent extends AbstractWidgetChartComponent implements OnInit {
  public id = selector;
  ...
  getService(params: IChartsEndpointParams) {
    const directoryCountersParams: IDirectoryCountersParams = {
      ...
      type: 'SOFTWARE_STATEMENT_REGISTERED'
    };
