...
const selector = 'app-events-notifications-table';
...
@Component({
  ...
  `,
  styleUrls: ['./events-notifications-table.component.scss']
})
export class EventsNotificationsTableComponent extends AbstractWidgetTableComponent implements OnInit {
  public id = selector;
