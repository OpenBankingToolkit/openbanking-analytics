...
const selector = 'app-funds-confirmation-table';
...
@Component({
  ...
  `,
  styleUrls: ['./funds-confirmation-table.component.scss']
})
export class FundsConfirmationTableComponent extends AbstractWidgetTableComponent implements OnInit {
  public id = selector;
