...
import { FundsConfirmationTableComponent } from './funds-confirmation-table.component';
import { AnaltyticsWidgetTableModule } from '../../widget-table/widget-table.module';

const declarations = [FundsConfirmationTableComponent];
...
export class FundsConfirmationTableModule {}
